...
There is a simple intuition of what it means to be a friend. A friend of Augustus cares about Augustus more than about other people. And, if we see Augustus, then we infer to see friends(s) of Augustus also. Please refer to [our arXiv preprint](https://arxiv.org/abs/2512.24843) for a more formal introduction.
